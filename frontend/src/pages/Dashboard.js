...
const Dashboard = () => {
  ...
  useEffect(() => {
    // Appel API pour récupérer les vraies statistiques du vendeur
    const fetchStats = async () => {
      setLoading(true);
      setError(null);
      try {
        const response = await api.get('/listings/seller-stats/');
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          {/* Annonces récentes dynamiques à ajouter ici si besoin */}
        </div>
